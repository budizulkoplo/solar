<x-app-layout>
    <x-slot name="pagetitle">Pembayaran Penjualan Unit</x-slot>
    ...
    <div class="app-content-header no-print">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0"><i class="bi bi-cash-coin text-primary me-2"></i>Pembayaran Penjualan Unit</h3>
                </div>
                <div class="col-sm-6 text-end">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="{{ route('penjualan-payment.index') }}" class="btn btn-info btn-sm">
                        ...
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Total Unit</h6>
                    ...
                    <div class="card financial-card">
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Cash</h6>
                                    <h4 class="mb-0">{{ $cashCount ?? 0 }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card financial-card">
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Kredit</h6>
                                    <h4 class="mb-0">{{ $creditCount ?? 0 }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card financial-card">
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Total Dibayar</h6>
                                    <h4 class="mb-0">Rp {{ number_format($totalPayment ?? 0, 0, ',', '.') }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card financial-card">
                        <div class="card-body py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Progress Pembayaran</h6>
                                    <h4 class="mb-0">{{ number_format($persentasePayment ?? 0, 1) }}%</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-3 no-print">
                <div class="card-body py-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <small class="text-muted">Progress Pembayaran Semua Unit</small>
                        <small class="text-muted">{{ number_format($persentasePayment ?? 0, 1) }}%</small>
                    </div>
                    <div class="progress progress-thin">
                        <div class="progress-bar bg-success" role="progressbar" 
                             style="width: {{ $persentasePayment ?? 0 }}%" 
                             aria-valuenow="{{ $persentasePayment ?? 0 }}" 
                ...
                <div class="card-body py-2">
                    <div class="row g-2 align-items-center">
                        <div class="col-md-2 col-sm-6">
                            ...
                            <select class="form-select form-select-sm" id="filterMethod" onchange="applyFilter()">
            ...
            <div class="card card-pencairan card-outline">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-house-check text-success"></i> Daftar Unit Terjual untuk Pembayaran
                    </h5>
                </div>
                <div class="card-body">
        ...
        <script>
            ...
            function applyFilter() {
                if (tablePenjualan) {
                    ...
                    tablePenjualan.ajax.url("{{ route('penjualan-payment.index') }}?payment_method_filter=" + method + 
                        "&status_filter=" + status + "&bank_filter=" + bank + "&search=" + encodeURIComponent(search)).load();
                }
            }
            ...
            function showQuickInfo(penjualanId) {
                $.ajax({
                    url: "{{ url('penjualan-payment/quick-info') }}/" + penjualanId,
                    type: 'GET',
            ...
            $(document).ready(function() {
                ...
                tablePenjualan = $('#tblPenjualan').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('penjualan-payment.index') }}",
                        type: 'GET',
                        data: function(d) {
                            d.payment_method_filter = $('#filterMethod').val();
                    ...
                    buttons: [
                        {
                            ...
                            title: 'Daftar Unit untuk Pembayaran',
                            exportOptions: {
