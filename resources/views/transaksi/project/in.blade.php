        ...
        $(document).ready(function() {
            ...
            function buildDetailRow(index, transaction = {}) {
                return `<tr>
                    ...
                    <td><input type="number" class="form-control form-control-sm text-end jml" name="transactions[${index}][jml]" value="${formatQtyInput(transaction.jml || 1)}" min="0.01" step="0.01"></td>
            ...
            function setSelectedCustomer(customer) {
                if (!isConstructionProject || !customer) {
                    return;
                }
