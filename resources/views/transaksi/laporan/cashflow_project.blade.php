<x-app-layout>
    ...
    <div class="print-header">
        <h4>Laporan Cashflow Project</h4>
    ...
    <x-slot name="jscustom">
        ...
        <script>
            ...
            function showDetail(notaId) {
                ...
                $.ajax({
                    url: "{{ route('transaksi.laporan.cashflow_project.view_nota') }}",
                    method: 'GET',
                    data: { id: notaId },
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#detailStatus')
                                .text(data.nota.status.toUpperCase())
                                .removeClass()
                            ...
                            $('#detailProject').text(data.nota.project);
                            ...
                            // Isi footer
                            $('#detailSubtotal').text('Rp ' + data.nota.subtotal);
                            $('#detailPpn').text('Rp ' + data.nota.ppn);
                            $('#detailDiskon').text('Rp ' + data.nota.diskon);
                            $('#detailGrandTotal').text('Rp ' + data.nota.total);
                                ...
                                data.payments.forEach(payment => {
                                    paymentsBody.append(`
                                        <tr>
                                            ...
                                            <td class="text-end">Rp ${payment.jumlah}</td>
                                        </tr>
                                    `);
                                });
                            } else {
            ...
            $(document).ready(function () {
                ...
                table = $('#tblCashflowProject').DataTable({
                    ...
                    ajax: {
                        ...
                        dataSrc: function(json) {
                            console.log('Data dari API:', json); // DEBUG
                            ...
                            if (json.data && json.data.length > 0) {
                                console.log('Contoh data pertama:', json.data[0]);
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            render: function(data, type, row) {
                                console.log('Row data untuk nota_no:', row); // DEBUG
                    ...
                    buttons: [
                        {
                            ...
                            action: function() {
                                const start = $('#start_date').val();
                                const end = $('#end_date').val();
                                const url = '{{ route("transaksi.laporan.cashflow_project.export_excel") }}?' + $.param({
                                    start_date: start,
                                    end_date: end
                                });
                        ...
                        },
                        {
                            ...
                            messageTop: function() {
                                ...
                                return `<div class="print-header">
                                            <h4 style="text-align: center; margin-bottom: 10px;">Laporan Cashflow Project</h4>
                ...
                $('#tblCashflowProject thead').on('keyup change', 'input.filter-input', function() {
                ...
                $('#tblCashflowProject thead').on('search', 'input.filter-input', function() {
                    if (this.value === '') {
                        const columnIndex = $(this).data('column');
