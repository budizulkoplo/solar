<x-app-layout>
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <h3 class="mb-0">Nota Penerimaan - {{ session('active_company_name') }}</h3>
        </div>
    </div>
                    ...
                    <div class="col-md-9">
                        <form id="frmNota" enctype="multipart/form-data">
                            ...
                            <div class="modal-header">
                                <h6 class="modal-title" id="modalNotaTitle">Form Nota Masuk - PT</h6>
    ...
    <x-slot name="jscustom">
        ...
        $(document).ready(function() {
            ...
            function resetForm() {
                ...
                // Bukti nota TIDAK wajib untuk transaksi masuk PT
            ...
            function submitFormData(formElement) {
                ...
                let url = notaId ? "/transaksi/pt/" + notaId + "/in" : "{{ route('transaksi.pt.store', 'in') }}";
